...
- [Pharmacy Management System Fullstack Architecture Document](#table-of-contents)
  ...
  - [Frontend Architecture](./frontend-architecture.md)
    ...
    - [API Integration](./frontend-architecture.md#api-integration)
      - [Structured Error Handling (why this exists — put this early)](./frontend-architecture.md#structured-error-handling-why-this-exists-put-this-early)
